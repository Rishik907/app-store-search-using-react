...
class AppStore extends Component {
  ...
  render() {
    ...
    const tabFilter = appsList.filter(eachApp => eachApp.category === tabId)
    const finalFilterList = tabFilter.filter(eachApp =>
      eachApp.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )

    return (
      <div className="app-store-container">
        <div className="head-come-input-container">
